        ...
        <FadeUpOnScroll>
          <section className="grid grid-cols-12 gap-5 py-24">
            <div className="col-span-6 flex flex-col gap-4 pt-5">
              <ServiceCard title={data[0].title} content={data[0].content} link={data[0].link} />
              <ServiceCard title={data[1].title} content={data[1].content} link={data[1].link} />
            </div>
            <div className="col-span-6 flex flex-col gap-4">
              <ServiceCard title={data[2].title} content={data[2].content} link={data[2].link} />
              <ServiceCard title={data[3].title} content={data[3].content} link={data[3].link} />
            </div>
          </section>
        </FadeUpOnScroll>
      </div>
