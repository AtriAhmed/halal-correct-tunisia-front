...
export default function AddLocationCmp() {
    function resetInput(){
        setInput({
        title:'',
        address:'',
...
const itemSubmit = (e) =>{
    ...
    const data = {
        ...
        axios.post('/api/create-location',data).then(res =>{
  ...
  return (
    ...
    <form className='flex flex-col gap-4 w-full' onSubmit={itemSubmit}>
        ...
        <button type="submit" className="self-center w-[50%] bg-blue-500 hover:bg-blue-700 rounded-full py-3 text-white font-bold">Add Category</button>
