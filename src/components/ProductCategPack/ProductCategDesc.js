      ...
      <div className="w-full px-8 py-10 max-w-w1300 mx-auto">
        ...
        <FadeUpOnScroll>
          <div className="pt-8 flex flex-col items-center scr800:flex-row gap-8">
            <p className="font-open text-base text-center scr800:text-left text-slate-900 font-semibold">
              ...
              <br />
              <br />
              Halal Correct categorizes the products according to its scope :
            </p>
          </div>
        </FadeUpOnScroll>
      </div>
