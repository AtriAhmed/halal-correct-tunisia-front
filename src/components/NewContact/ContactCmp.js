            ...
            <div className="w-full px-8 py-8 max-w-w1300 mx-auto">
                <FadeUpOnScroll>
                    ...
                    <div className="shadow-xl grid grid-cols-12 p-10 bg-white gap-4 rounded-xl">
                        <div className="col-span-12 xl:col-span-5"><div className="w-full">
                            <iframe
                        ...
                        <div className="break-all col-span-12 xl:col-span-7 flex flex-col gap-4">
                            <div className="grid grid-cols-12 gap-4 text-gray-500">
                                <div className="col-span-12 sm:col-span-4 shadow-xl flex flex-col items-center py-5 px-5 rounded-xl"><img src={phoneIcon} /><div>(+216) 29503804</div></div>
                                <div className="col-span-12 sm:col-span-4 shadow-xl flex flex-col items-center py-5 px-5 rounded-xl"><img src={hornIcon} /><div>halalQMS@halalcorrect.com</div></div>
                                <div className="col-span-12 sm:col-span-4 shadow-xl flex flex-col items-center py-5 px-5 rounded-xl"><img src={locationIcon} /><div>immeuble new Tower - centre urbain nord – Tunis</div></div>
                            </div>
                            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                                <div className="grid grid-cols-12 gap-4">
                                    ...
                                    <div className="col-span-12 sm:col-span-6 flex flex-col"><textarea className="py-3 px-5 border rounded-3xl outline-none w-full" name="message" placeholder="Message" id="" cols="30" rows="8" value={message} onChange={e => setMessage(e.target.value)} ></textarea>
                                        <span className="text-red-500">{errors?.message}</span>
                                    </div>
                                </div>
                                <div className="flex justify-center"><button className="w-full sm:w-[50%]  border border-[#4da6e7] text-[#4da6e7] rounded-full p-3 hover:bg-[#4da6e7] transition duration-300 hover:text-white">Envoyer le message maintenant.</button></div>
                            </form>
                        </div>
                    </div>
                </FadeUpOnScroll>
