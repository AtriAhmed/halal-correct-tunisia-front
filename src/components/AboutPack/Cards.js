  ...
  return (
    <div className="w-full">
      <div className="w-full px-8 py-10 max-w-w1300 mx-auto">
        <div className=" grid grid-cols-1 scr900:grid-cols-3 gap-10">
