        ...
        <FadeUpOnScroll>
          <div className="pt-8 flex flex-col items-center scr800:flex-row gap-8">
            <p className="font-open font-normal text-base text-center scr800:text-left text-slate-900">
              We intervene as a third-audit auditor to evaluate your systems and
              issue the requisite certification.
              <br />
              <br />
              Our certified auditors do their work professionally, acting
              impartially, and applying their know-how. The diverse nature of
              our audits and our auditors’ capacity to adapt themselves to your
              specific context makes them a key success factor for getting ahead
              of the curve.
              <br />
              <br />
