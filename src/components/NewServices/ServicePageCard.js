                ...
                selected == 0 ?
                    ...
                    : selected == 1 ?
                        <>
                            ...
                            <div className='col-span-12 lg:col-span-6 flex flex-col gap-6 text-start justify-center'>
...
<div className='col-span-12 lg:col-span-6 flex flex-col gap-4 text-start justify-center'>
