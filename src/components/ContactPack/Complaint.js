    ...
    return (
      <div className="w-full max-w-[500px] px-10 py-28 rounded-lg bg-[#0F70B7] flex flex-col items-center justify-center">
        <h3 className="mb-6 font-open font-light text-3xl scr800:text-4xl text-center text-white">
          Votre Réclamation a été envoyer acec succès
        </h3>
    ...
    <div className="w-full max-w-[500px] px-6 scr600:px-10 py-10 rounded-lg bg-[#0F70B7]">
      ...
      >
        ...
        <textarea
          ...
          placeholder="Merci de fournir votre réclamation."
          rows="4"
        ...
        <p className="font-bold text-black">
          En savoir plus,{" "}
          <a
            href="/APC 1.1 Regulations Complaint and Appeal committee.pdf"
            target="_blank"
            rel="noopener"
            className="text-sky-100 hover:text-sky-300 underline"
          >
            {" "}
            Cliquer ici
          </a>
