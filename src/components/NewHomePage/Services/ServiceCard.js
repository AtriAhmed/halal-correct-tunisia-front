...
export default function ServiceCard({ title, content, link, icon }) {
    ...
    return (
        <div className="col-span-12 sm:col-span-6 group overflow-hidden hover:shadow-2xl hover:ring-[#0F70B7] hover:ring-2 transition-all duration-300 rounded-xl bg-white p-8 flex flex-col gap-4 min-h-[500px]" onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} >
