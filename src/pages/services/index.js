                ...
                <div className='grid grid-cols-12 '>
                    ...
                    <div className='col-span-6 flex flex-col gap-6 justify-center'>
                        ...
                        <div className='grid grid-cols-12 gap-2'>
                            ...
                            <div className='col-span-6 shadow-xl p-5 rounded-xl flex items-center hover:scale-105 transition duration-200 hover:shadow-2xl hover:font-bold'>✔ Examiner les systèmes de documentation et effectuer des audits internes.
                            </div>
                            <div className='col-span-6 shadow-xl p-5 rounded-xl flex items-center hover:scale-105 transition duration-200 hover:shadow-2xl hover:font-bold'>✔ Mise en place et pilotage de la filière agro-alimentaire durable et biologique « Halal Tayyib ».</div>
                            <div className='col-span-6 shadow-xl p-5 rounded-xl flex items-center hover:scale-105 transition duration-200 hover:shadow-2xl hover:font-bold'>✔ Conseils et accompagnement pour la réalisation de la Certification Halal souhaitée pour les entreprises / Services certifiés Halal</div>
                            <div className='col-span-6 shadow-xl p-5 rounded-xl flex items-center hover:scale-105 transition duration-200 hover:shadow-2xl hover:font-bold'>✔ Mise en place et pilotage d'un système de gestion de la qualité Halal robuste « QMS Halal » conformément aux normes internationales Halal.</div>
                        </div>
                    </div>
                </div>
                <div className='grid grid-cols-12 gap-2'>
                    <div className='col-span-3 shadow-xl p-5 rounded-xl flex items-center hover:scale-105 transition duration-200 hover:shadow-2xl hover:font-bold'>✔ Organiser des sessions professionnelles et des formations pour l'industrie alimentaire Halal, la restauration et le marché de détail ;</div>
                    <div className='col-span-3 shadow-xl p-5 rounded-xl flex items-center hover:scale-105 transition duration-200 hover:shadow-2xl hover:font-bold'>✔ Conseils et support aux demandes de reconnaissances et d'accréditation Halal pour les entreprises et les Cbs</div>
                    <div className='col-span-3 shadow-xl p-5 rounded-xl flex items-center hover:scale-105 transition duration-200 hover:shadow-2xl hover:font-bold'>✔ Mener et évaluer l'audit Halal et la sélection des matières premières</div>
                    <div className='col-span-3 shadow-xl p-5 rounded-xl flex items-center hover:scale-105 transition duration-200 hover:shadow-2xl hover:font-bold'>✔ Organisation de conférences sectorielles.</div>
                </div>
