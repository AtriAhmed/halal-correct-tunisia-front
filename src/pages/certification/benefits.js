...
export const Head = () => (
  <Seo
    title="Benefits"
    description="Halal Correct has been recognized nationally and internationally for its halal certification services. We work with more than hundred clients every year!"
  />
)
